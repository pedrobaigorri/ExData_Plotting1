...
##
## This script contains the code to generate the plot3 of exercise:
...
{   
    ...
    legend("topright", lwd = c(2.5, 2.5, 2.5), col = c("black", "red", "blue"), legend = c("Sub_meetering_1", "Sub_meetering_2", "Sub_meetering_3"))
